	...
	<div id='onetoNsetyi' class="big">
		<div class="onetoNsetyi-conten">
			<ul>
				...
				<li>
					...
					<span>
				   	...
				   	<img src="../../../assets/images/notes_normal.png"/>
				   	<i id="font"></i>
				   <a class="chong">
				            重选
				   	 </a>
			...
			<p>
				...
				<span id="next">继续填写本链接</span>
			</p>
		</div>
		<div class='box1'>
			<p class='text'>
				<span id='tit'></span>
				<span class='iconfont icon-bianji right' @click="right"></span>
			</p>
			<div class='container'>
				<span class='item' v-for="item in lessonList" :itemClick="itemClick">{{item}}</span >
