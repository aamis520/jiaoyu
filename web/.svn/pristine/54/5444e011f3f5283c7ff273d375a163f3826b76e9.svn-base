		...
		<ul class="stuinfo">
			<li class="set-content">
				...
				<ul class="content-chose">
					...
					<li><span>VIP类型筛选</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
				</ul>
			</li>
			<li class="set-content">
				<span class="content-title">基本信息</span>
				<ul class="content-chose">
					<li><span>学管姓名</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>咨询师姓名</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>学生人数</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>签约总课时数</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>签约总金额</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>已缴课时</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>已缴金额</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>欠缴课时</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>欠缴金额</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>已耗课时</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>已耗金额</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>剩余课时</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>剩余金额</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>应续人数</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>已续人数</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>已续课时</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>已续金额</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>续费率</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					...
					<li><span>催欠金额</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>新签课时</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>新签已缴课时</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>新签未缴课时</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
					<li><span>新签欠费额</span><i class="iconfont icon-yishitubiaoshuchu- green"></i></li>
				</ul>
			</li>
		</ul>
