    ...
    <div class="opening_body">
         <section>
            ...
            <div>
                <p>
                    <span v-if="false">{{}}</span>
                    <img src="../../../../static/home-icon/xgxgts.png" v-if="false"></img>
                </p>
            </div> 
         </section> 
         <ul>      
            <li v-for="(ele,index) in list.course_period_list" :key="index">
                <div>
                    <img src="../../../../static/home-icon/xgxgts.png" ></img>
                    <p>
                        <span>{{ele.name}}</span> 
                        <i v-if="false"> · </i>
                ...
                <div>
                    ...
                    <img src="../../../assets/newcad1.png" @click="addClass(list.course_name ,ele , index ,list ,ele.time_label)"> </img>
