            ...
            .picShow {
                ...
                .picSel-mess {
                    ...
                    .acncel {
                        ...
                        top: 0;
                        right: 0;
                        background: url("../../../images/home-schint/stuStyxxx.png") no-repeat;
                    ...
                    ul{
                        li{
                            ...
                            i{
                                ...
                                width:10px;
                                height: 10px;
                                background: url("../../../images/home-schint/caxx.png") no-repeat;
                                background-size: 100% 100%;
                                margin-left:13px;
                                cursor: pointer;
                            }
        ...
        .fix-com{
            ...
            .fix-top{
                ...
                .ul-top-right{
                   ...
                   width: 16px;
                   height: 16px;
                   background: url("../../../images/home-schint/bigX.png") no-repeat;
                   background-size: 100% 100%;
               }
            .fix-nav{
                ...
                ul{
                    ...
                    li{
                        ...
                        .p1{
                            ...
                            .riSp{
                                ...
                                i{
                                    ...
                                    width:15px ;
                                    height: 13px;
                                    background: url("../../../images/home-schint/favour.png") no-repeat;
                                    background-size: 100% 100%;
                                    position: absolute;
                                    top: 3px;
                                    left:-21px;
                        ...
                        .head-pic{
                            ...
                            width:30px ;
                            height: 30px;
                            background: url("../../../images/home-schint/picStu.png") no-repeat;
                            background-size: 100% 100%;
                            position: absolute;
                            top: 16px;
                            left:30px;
                        ...
                        .head-sel-one{
                            ...
                            width:20px ;
                            height: 20px;
                            background: url("../../../images/home-schint/cir1.png") no-repeat;
                            background-size: 100% 100%;
                            position: absolute;
                            top: 20px;
                            left:0px;
                        ...
                        .head-sel-Two{
                            ...
                            width:20px ;
                            height: 20px;
                            background: url("../../../images/home-schint/selTrue.png") no-repeat;
                            background-size: 100% 100%;
                            position: absolute;
                            top: 20px;
                            left:0px;
            ...
            .navArea{
                ...
                .fixCue{
                    ...
                    i{
                        ...
                        width: 18px;
                        height: 14px;
                        background: url("../../../images/home-schint/cue.png") no-repeat;
                        background-size: 100% 100%;
                        margin-right: 5px;
                    }
                }
        ...
        <div class="stuPicShow" v-show="bool">
            ...
            <div class="picShow">
                <div class="addStu" @click="bool=false">
                    <div class="posCen">
                        <img src="../../../images/home-schint/stuStyAdd.png" alt="">
                        <p>添加学生</p>
                    </div>
                </div>
                <div class="picSel-mess" v-for="item in stuList">
                    ...
                    <div class="evaluate-show"  @click="commentList(item)">
                        <img  src="../../../images/home-schint/stuStymess.png" alt="">
                ...
                <div class="stu-end-left">
                    <el-upload
                        ...
                        <div>
                            ...
                            <img v-if="!imageUrl" src="images/home-schint/interconnect/stuStyAdd.png">
                ...
                <div class="picShow">
                    <div class="ngl_img">
                        ...
                        <el-upload
                            ...
                            :file-list="inputData"
                        >
                            <img src="../../../images/home-schint/addimg.png"></img>
                            <span>添加学生图片</span>
                        </el-upload>
                    </div>
                </div>
...
<script>
    ...
    import interconnection from  "@commonJS/const"
    export default {
        data(){
            return{
                saveUrl:interconnection.interconnection+"v1/studentShow/saveStudentShow",
                getAllStuMessuRl:interconnection.interconnection+"v1/studentShow/findStudentShowList",
                imageUrl: '',//上传的图片路径
        ...
        methods:{
            delStuMess(item){
                let obj ={
                    studentShowId :item.studentShowId
                }
                this.axios.post(interconnection.interconnection+"/v1/studentShow/deleteStudentShow",obj).then(res => {
                    this.showStuList();
                }).catch(error => {
                    err(error)
                })
...
//                console.log(555)
                for(let i =0;i<this.comment.length;i++){
                    let obj ={
                        studentShowCommentId :this.comment[i].studentShowCommentId
                    }
                    if(this.comment[i].bool == true){
                        this.axios.post(interconnection.interconnection+"/v1/studentShow/deleteStudentShowComment",obj).then(res => {
            ...
            upMess(item){
                this.axios.post(interconnection.interconnection+"/v1/studentShow/getStudentShow?studentShowId="+item.studentShowId).then(res => {
...
//                console.log(this.$store.state.scho.arrEnd[0].school_id)
                    ...
                    this.axios.post(this.saveUrl,json).then(res => {
                        this.showStuList();
                        this.partOrAll = "";
                        this.stuName = "";
                        this.stuSchol = "";
...
//                console.log(this.$store.state.scho.arrEnd[0].school_id)
            ...
            showStuList(){
                ...
                this.axios.post(this.getAllStuMessuRl,obj).then(res => {
...
//                    +"&accessToken=aaaa&commentContent=模拟数据，删完自己添加，慎重！！！").then(res => {
...
//                })
                ...
                this.axios.post(interconnection.interconnection+"/v1/studentShow/findStudentShowCommentList?studentShowId="+item.studentShowId).then(res => {
//                        console.log(res.data.messages.data)
            ...
            delCommon(item){
                this.axios.post(interconnection.interconnection+"/v1/studentShow/deleteStudentShowComment?studentShowCommentId="+item.studentShowCommentId).then(res => {
...
//            }
//            console.log(accAdd(2.23,2.14))
            console.log('m',this.$moment().format('L'))
          this.showStuList();        }
    }
</script>
