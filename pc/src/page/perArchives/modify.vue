        ...
        <div class="main" v-for="(item,index) in data">
            <div class="left">
                <div class="center">
                    ...
                    <ul class="datas">
                        ...
                        <li>
                            <img src="../../images/map/4-1.png" alt="">
                ...
                <div class="details">
                    <div style="background: #f7f8fc;">
                        <i><img src="../../images/map/15.png" alt=""></i>
                        <span style="color:#31c27c;">详细信息</span>
                    </div>
                    <!--<div>-->
                        <!--<i><img src="../../images/map/16.png" alt=""></i>-->
                        <!--<span>人事变动</span>-->
                    <!--</div>-->
                    <!--<div>-->
                        <!--<i><img src="../../images/map/17.png" alt=""></i>-->
                        <!--<span>工作评定</span>-->
                    <!--</div>-->
                    <!--<div>-->
                        <!--<i><img src="../../images/map/18.png" alt=""></i>-->
                        <!--<span>个人考勤</span>-->
                    <!--</div>-->
                </div>
            </div>
            <div class="right">
                <div class="detailed">
                    <span>详细信息</span>
                    <div>
                        <i><img src="../../images/map/2_03.gif" alt="" @click="Jump(com)"></i>
                        <i style="margin-right: 20px;"><img src="../../images/map/2_06.gif" alt=""></i>
                    </div>
                </div>
                <div class="basic">
                    <div class="bas-t">
        ...
        .basic{
            ...
            .bas-t{
                ...
                i{
                    ...
                    margin-top: 20px;
                    float: left;
                    background: url(../../images/map/19.png) no-repeat 100% 100%;
                }
                .i5{
                    background: url(../../images/map/21.png) no-repeat 100% 100%;
                    }
                .i6{
                    background: url(../../images/map/24.png) no-repeat 100% 100%;
                }
                .i4{
                    background: url(../../images/map/22.png) no-repeat 100% 100%;
                    }
                .i3{
                    background: url(../../images/map/23.png) no-repeat 100% 100%;
                    }
                .i1{
                    background: url(../../images/map/20.png) no-repeat 100% 100%;
                }
