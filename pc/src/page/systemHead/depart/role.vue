...
export default {
  ...
  methods: {
    ...
    getRoleList(headSchoolId, campusType, success) {
      this.axios
        .post(
          this.url + "getRoleList?accessToken=aaaa",
          qs.stringify({
            headSchoolId,
            campusType
          })
    ...
    addRole(headSchoolId, campusType, roleName, success) {
      this.axios
        .post(
          this.url + "addRole?accessToken=aaaa",
          qs.stringify({
            headSchoolId,
            campusType,
            roleName
    ...
    removeRole(roleId, success) {
      this.axios
        .post(
          this.url + "deleteRole?accessToken=aaaa",
          qs.stringify({
            roleId
          })
        )
