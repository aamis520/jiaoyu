	...
	<div class="table_list">
		<ul class="table_ul_list">
			<li v-for="(ele,index) in list.data" :key="index">
				...
				<span>
                    <img src="../../../../images/system-campus/bdj.png" class="table_class_img"></img>
                    {{ele.room_name}}
                </span>
				...
				<span class="span_last_table">
                    ...
                    <div v-if="!ele.is_seat_required && (icon == 'bdj' || icon == 'vdd')">
                        ...
                        <b>{{ele.valid_num}}</b>
                        个
                        <img class="table_class_img" src="../../../../images/system-campus/xg.png" @click="customclassClick(ele,index)" v-if="false"></img>
                    </div>
                    <!-- 判断是否为一对一辅导  -->
				...
				<span class="span_last_table">
                    <img class="last_img" src="../../../../images/system-campus/xdg.png" @click="modify(ele)"></img>
                    <img class="last_img" src="../../../../images/system-campus/sds.png" @click="remveClass(ele,index)"></img>
                </span>
			</li>
		</ul>
		...
		<img src="../../../../images/system-campus/youhuiAdd.png" class="add_class_room" @click="addClassRoom()"></img>
		...
		<div class="table_zd" :style="{ width: windowWidth + 'px' }" v-if="classTableTrue == 1004004">
			<section>
				<h1>提示
					<img src="../../../../images/system-campus/close.jpg" @click="yeasClick"/>
				</h1>
				<img src="../../../../images/system-campus/classtishi.gif" class="R">
				<h2>您添加的班级已经存在</h2>
				<p>
					<img src="../../../../images/system-campus/table_c.png" alt="" @click="yeasClick" />
					<img src="../../../../images/system-campus/table_d.png" alt=""  @click="yeasClick"/>
				</p>
			</section>
		</div>
	</div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			ok() {
				let pageInitUrl = cont.campus + "v1/campus/classroom/deleteClassRoom?head_id=" + this.$ls.get("USER_INFO").headSchoolId
				let pageInitparmes = {
					id: this.removeId
				}
