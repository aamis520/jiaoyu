		...
		<div class="opening_add_section" :style="{  top : Top + 'px' }">
			<header>
				...
				<div class="position_img">
					<img src="../../../../images/system-campus/bookadd.png" />
					<img src="../../../../images/system-campus/axx.png" alt="" @click="cancelClick" class="guanchaca"/>
				</div>
			</header>
					...
					<div class="op_body_table_rt">  		
						 <div>
							 ...
							 <section>
							 	...
							 	<img src="../../../../images/system-campus/tanhao.png"/>
							 </section>
						 </div> 
					</div>					
				</div>
				...
				<div class="op_body_table" v-if="spanLei">
					...
					<div class="op_body_table_rt"> 
						<template>
						  ...
						  <b>在家长端显示<img src="../../../../images/system-campus/tanhao.png" alt="" /></b>
						</template>
					</div>					
				</div>
	...
	export default {
		...
		methods: {
			...
			ajaxClass(jsonp){
				...
				this.$emit('close')
				let url = cont.campus+"v1/campus/coursechain/insertCommonClassAndClassPeriod"
