<style lang="less">
	...
	.cOperation{
		...
		.cOperation_right{
			...
			.crBg01{
				background-image: url(../../../images/home-schint/topicDetial01.png);
				background-repeat: no-repeat;
			}
			.crBg02{
				background-image: url(../../../images/home-schint/topicDetial02.png);
				background-repeat: no-repeat;
			}
			.crBg03{
				background-image: url(../../../images/home-schint/topicDetial03.png);
				background-repeat: no-repeat;
			}
		}
	}
	...
	export default{
		...
		data(){
			return{
				...
				nosure_big:require('../../../images/home-schint/nosure_big.png'),//默认大头像小头像
			}
		},
        computed:{
        	...mapState({
