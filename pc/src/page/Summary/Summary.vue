<template>
    <div id="pre" :style="{backgroundImage:'url('+img+')'}">
        ...
        <div class="main">
            <div class="top">
                <p class="top-l">
                    <img src="../../images/Summary/3.png" alt="" @click="trans(newday,'0')" class="l">
                    <span class="time" v-model="newday">{{newday}}</span>
                    <img src="../../images/Summary/2.png" alt="" @click="trans(newday,'1')" class="r">
                </p>
                <p class="top-r">
                    18春
                </p>
            ...
            <div class="hide" v-show="ishide">
                <div class="h-top">
                    {{titleData}}
                    <img src="../../images/Summary/1.png" alt="" class="close" @click="close()">
                </div>
                <div class="h-center" style="border-bottom: 1px solid #eceff4">
                    <p class="h-topl">
                        <img src="../../images/Summary/3.png" alt="" @click="trans(newday,'0')" class="ll">
                        <span class="h-toplo">{{newday}}</span>
                        <img src="../../images/Summary/2.png" alt="" @click="trans(newday,'1')" class="rr">
                    </p>
                    <p class="h-topr">
                        18春
                    </p>
...
<style lang="less" scoped>
    ...
    .main {
        ...
        border-radius: 5px;
        position: relative;
        background: #fff url(../../images/Summary/hd_01.gif) no-repeat top center;
    }
